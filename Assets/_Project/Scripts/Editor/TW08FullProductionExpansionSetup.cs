    ...
    public static class TW08FullProductionExpansionSetup
    {
        ...
        public static void BuildFullProductionExpansion()
        {
            try
            {
                ...
                EditorUtility.DisplayProgressBar("The Warehouse Nº 08", "Criando 3 pistas de corrida...", 0.76f);
                List<string> racePaths = TW08RaceSceneBuilder.BuildAll(data);

                EditorUtility.DisplayProgressBar("The Warehouse Nº 08", "Atualizando Build Settings...", 0.92f);
                ...
                EditorUtility.DisplayDialog(
                    ...
                    "Expansão de produção materializada.\n\n" +
                    ...
                    "Próximo gate obrigatório: Console sem erros + EditMode/PlayMode Test Runner + playtest manual.",
                    "OK");
            }
