# `godot/levels/reference/` — material de referência interno
...
O `.gitignore` do projeto raiz exclui `godot/levels/reference/*.xsb` e
`godot/levels/reference/*.json`. Este `README.md` é o único arquivo
desta pasta que entra no Git.
...
para rodar o jogo. As fases distribuíveis ficam em `godot/levels/new/`.
